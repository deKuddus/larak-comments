...
namespace Larak\Comments;

use Illuminate\Database\Eloquent\Model;
use Larak\Comments\Events\CommentCreated;
use Larak\Comments\Events\CommentUpdated;
use Larak\Comments\Events\CommentDeleted;
...
class Comment extends Model
{
     ...
     */
    protected $fillable = [
        'comment', 'approved', 'guest_name', 'guest_email', 'ratings'
    ];
