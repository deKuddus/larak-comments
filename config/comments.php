...
return [
     ...
     */
    'model' => \Larak\Comments\Comment::class,
     ...
     */
    'permissions' => [
        'create-comment' => 'Larak\Comments\CommentPolicy@create',
        'delete-comment' => 'Larak\Comments\CommentPolicy@delete',
        'edit-comment' => 'Larak\Comments\CommentPolicy@update',
        'reply-to-comment' => 'Larak\Comments\CommentPolicy@reply',
    ],

    /**
     * The Comment Controller.
     * Change this to your own implementation of the CommentController.
     * You can use the \Larak\Comments\CommentControllerInterface.
     */
    'controller' => '\Larak\Comments\CommentController',
